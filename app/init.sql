...
# Database: alena
# Generation Time: 2015-08-05 05:44:42 +0000
# ************************************************************
...
INSERT INTO `article` (`id`, `created_at`, `name`, `user_id`, `annotation`, `text`)
VALUES
  (1,'2015-04-06 22:11:21','První článek z editoru',1,'<p>Tohle se zobraz&iacute; jako n&aacute;hled, možn&aacute; to ani na webu nebude potřeba.</p>','<p>Asi bych to sem nměl ps&aacute;t, ale heslo je \"sosprohudbu\" ale pst ;-)</p>\n<p>&nbsp;</p>\n<p>&nbsp;</p>'),
